...
class RatingWidget extends StatelessWidget {
  ...
  /// Returns a RatingWidgetResponse with user's rating and comment values
  final Function(RatingWidgetResponse) onSubmitted;
  ...
  Widget build(BuildContext context) {
    ...
    final _response = RatingWidgetResponse(rating: initialRating);
...
class RatingWidgetResponse {
  ...
  RatingWidgetResponse({this.rating = 1});
}
